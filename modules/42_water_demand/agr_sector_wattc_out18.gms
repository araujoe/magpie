...
*'
*' * A global static value of irrigation efficiency that is defined as the global weighted 
*' average of water losses from
*' source to field ("conveyance efficiency times management factor") from @PIK_report104_2007.
*' Here, irrigated area from @siebert_FAO_2007 has been used as aggregation weight.
*'
*' * A regression of country values of the "conveyance efficiency times management factor" from
*' @PIK_report104_2007 on GDP. 
*'
...
*' sectors is set to 0. The default value is 0.5.
*'
...
*' * Environmental flow requirements (EFR) are calculated from LPJmL inputs according
...
$Ifi "%phase%" == "sets" $include "./modules/42_water_demand/agr_sector_wattc_out18/sets.gms"
$Ifi "%phase%" == "declarations" $include "./modules/42_water_demand/agr_sector_wattc_out18/declarations.gms"
$Ifi "%phase%" == "input" $include "./modules/42_water_demand/agr_sector_wattc_out18/input.gms"
$Ifi "%phase%" == "equations" $include "./modules/42_water_demand/agr_sector_wattc_out18/equations.gms"
$Ifi "%phase%" == "scaling" $include "./modules/42_water_demand/agr_sector_wattc_out18/scaling.gms"
$Ifi "%phase%" == "preloop" $include "./modules/42_water_demand/agr_sector_wattc_out18/preloop.gms"
$Ifi "%phase%" == "presolve" $include "./modules/42_water_demand/agr_sector_wattc_out18/presolve.gms"
$Ifi "%phase%" == "postsolve" $include "./modules/42_water_demand/agr_sector_wattc_out18/postsolve.gms"
